...
**Publicado:** 20230509 · **Subtítulos:** en (pueden ser auto-generados)
**Tipo:** transcript de vídeo (speech-to-text; posibles erratas/muletillas). Cita como `[yt-transcripts/20230509-the-week-on-chain-bitcoin-fee-pressure-explodes-higher-week-19-2023-bi.md]`.
