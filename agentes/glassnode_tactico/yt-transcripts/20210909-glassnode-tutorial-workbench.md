...
**Publicado:** 20210909 · **Subtítulos:** en (pueden ser auto-generados)
**Tipo:** transcript de vídeo (speech-to-text; posibles erratas/muletillas). Cita como `[yt-transcripts/20210909-glassnode-tutorial-workbench.md]`.
