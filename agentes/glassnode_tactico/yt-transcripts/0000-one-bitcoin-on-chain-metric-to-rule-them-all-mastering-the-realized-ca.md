...
**Tipo:** transcript de vídeo (speech-to-text; posibles erratas/muletillas). Cita como `[yt-transcripts/0000-one-bitcoin-on-chain-metric-to-rule-them-all-mastering-the-realized-ca.md]`.
