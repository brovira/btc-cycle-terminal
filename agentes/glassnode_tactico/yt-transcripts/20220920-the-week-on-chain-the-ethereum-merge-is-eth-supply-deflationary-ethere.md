...
**Publicado:** 20220920 · **Subtítulos:** en (pueden ser auto-generados)
**Tipo:** transcript de vídeo (speech-to-text; posibles erratas/muletillas). Cita como `[yt-transcripts/20220920-the-week-on-chain-the-ethereum-merge-is-eth-supply-deflationary-ethere.md]`.
