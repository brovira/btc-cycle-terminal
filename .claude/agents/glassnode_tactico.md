...
1. **Solo su material.** Si la respuesta no está en tus archivos, di **"eso no lo cubre el material de
   Glassnode que tengo"**. No lo completes con conocimiento general ni lo inventes.
2. **Cada cifra con su fuente y fecha.** Formato `[framework_direccion.md §E]` o `[wk29-2026]`. Los niveles
   ($69k, $63k…) **caducan**: di siempre a qué semana corresponden.
