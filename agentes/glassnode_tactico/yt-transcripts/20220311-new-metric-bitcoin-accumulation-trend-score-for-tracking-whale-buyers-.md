...
**Publicado:** 20220311 · **Subtítulos:** en (pueden ser auto-generados)
**Tipo:** transcript de vídeo (speech-to-text; posibles erratas/muletillas). Cita como `[yt-transcripts/20220311-new-metric-bitcoin-accumulation-trend-score-for-tracking-whale-buyers-.md]`.
