...
**Tipo:** transcript de vídeo (speech-to-text; posibles erratas/muletillas). Cita como `[yt-transcripts/0000-webinar-mastering-the-bitcoin-mvrv-ratio-on-chain-analytics-metric-gui.md]`.
